...
export const EVOLVABLE_PARAM_KEYS = [
  ...
  'clusterInterdictionPriority',
  'clusterIsolationCommitShare',
  'clusterIsolationDuration',
  'frontlineMeleeShare',
...
export const MUTATION_RANGES: Record<Exclude<EvolvableParamKey, 'militaryLevelMixTarget'>, MutationRange> = {
  ...
  clusterInterdictionPriority: { min: 0, max: 1, exploration: 'medium' },
  clusterIsolationCommitShare: { min: 0, max: 1, exploration: 'medium' },
  clusterIsolationDuration: { min: 1, max: 15, round: true, exploration: 'medium' },
